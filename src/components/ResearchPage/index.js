...
<ul className="space-y-3">
    ...
    {/* Add more papers as needed */}
          ...
          Logic and foundations
                  ...
                  <p className={`${subtleText}`}>
	  We believe that theory and practice go hand in hand. Our practical work on quantum programming is complemented by an interest in foundational issues and approaches, such as logic, category theory, and the role of dualities.
      </p>
<ul className="space-y-3">
    <li className={`${subtleText}`}>
      <a 
    ...
    {/* Add more papers as needed */}
	                  ...
	                  {/* Paper Image */}
          <div className="aspect-auto w-xs overflow-hidden">
                  <img
