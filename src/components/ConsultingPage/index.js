...
const SelectedWorkPage = ({ isDark, setIsDark, waveState, setWaveState }) => {
  ...
  const selectedWork = [
    ...
    },
    {
      ...
      organization: 'Blog',
      type: 'Creative',
      brief: 'Blogging across dimensions, from self-reflexive word games to alien math.',
  ...
  return (
    <div className={`min-h-screen transition-colors`}>
	  ...
	  Here are a few projects from recent years (not under the Torsor moniker). Open to exploring collaborations the value doing something genuinely different, whether in research, software development or education.
            </p>
          </motion.div>
