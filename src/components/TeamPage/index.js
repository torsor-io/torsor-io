    ...
    <div className={`min-h-screen transition-colors`}>
      ...
      />
        ...
        <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          David has a PhD in string theory and black holes (UBC 2022), a masters degree in particle physics, and undergraduate degrees in philosophy and math. Before going rogue, he worked at <a href="https://www.xanadu.ai/" className={`hover:underline`}>Xanadu</a> (2022–25), where he helped architect the <a href="https://pennylane.ai/codebook" className={`hover:underline`}>PennyLane Quantum Codebook</a>, created Xanadu's <a href="https://pennylane.ai/qml/demos/circuits_as_fourier_series" className={`hover:underline`}>first interactive demos</a>, built <a href="https://arxiv.org/abs/2405.03754" className={`hover:underline`}>early fault-tolerant algorithms</a>, <a href="https://pennylane.ai/blog/2024/04/quantum_transformers" className={`hover:underline`}>thought critically</a> about quantum LLMs, and invented <a href="https://arxiv.org/abs/2409.00172" className={`hover:underline`}>new ways</a> to use quantum computers for pattern detection.
                  </p>
