...
<p className={`${subtleText}`}>We currently have no open roles. Feel free to visit the <a href="/#puzzle" className={`hover:underline`}>terminal</a> and  <tt>dice > mail</tt>.</p>
</motion.div>
