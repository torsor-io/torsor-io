...
<p className={`${subtleText}`}>We currently have no openings, but feel free to visit the <a href="/#puzzle" className={`hover:underline`}>terminal</a> and express interest via <tt>dice > mail</tt>.</p>
</motion.div>
