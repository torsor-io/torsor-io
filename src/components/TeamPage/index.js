...
<p className={`${subtleText}`}>We're not hiring right now. Feel free to visit the <a href="/#puzzle" className={`hover:underline`}>terminal</a> and express interest via <tt>dice > mail</tt>.</p>
</motion.div>
